                ...
                <div class="card-body">
                    <form action="../includes/facility.inc.php" method="POST">
                        <div class="mb-3">
                            ...
                            <input type="text" id="facility_name" name="facility_name" class="form-control" maxlength= "30">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" id="capacity" name="capacity" class="form-control" max="1000">
                        </div>
                        <div class="mb-3">
                            <label for="operating_time_start">Operating Time Start</label>
                            <input type="time" id="operating_time_start" name="operating_time_start" class="form-control">
                        </div>
                        <div class="mb-3">
                            <label for="operating_time_end">Operating Time End</label>
                            <input type="time" id="operating_time_end" name="operating_time_end" class="form-control">
                        </div>
                        <div class="mb-3">
